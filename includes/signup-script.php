    ...
    if ($_POST['password'] == $_POST['confirm-password']) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($mysqli->query($sql) === true) {
                ...
                if (isset($_GET['referto']) && !empty($_GET['referto'])) {
                    $ref_url = $_GET['referto'];
                    if($ref_url == "https://thesparkng.com/test/magazine/" or "https://thesparkng.com/test/magazine" or "http://thesparkng.com/test/magazine" or $ref_url == "http://thesparkng.com/test/magazine/") {
                        header("location: http://www.thesparkng.com/test/magazine/read?id=25");
                        $show_modal = false;
                    } else {
                        header("location: $ref_url");
                        $show_modal = true;
                ...
                $message_body = '
                    ...
                    'thesparkng.com/test/verify?email=' . $email . '&hash=' . $hash;
